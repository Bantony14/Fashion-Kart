      ...
      <div className="w-64 bg-white shadow rounded-lg p-5">
        ...
        <ul className="space-y-3 text-sm">
          <li
            ...
            className={activeTab === "dashboard" ? "text-blue-600 font-medium cursor-pointer" : "cursor-pointer hover:text-blue-600"}
          >
            Dashboard
          </li>
          ...
          <li
            ...
            className={activeTab === "orders" ? "text-blue-600 font-medium cursor-pointer" : "cursor-pointer hover:text-blue-600"}
          >
            Orders
          </li>
          ...
          <li
            ...
            className={activeTab === "wishlist" ? "text-blue-600 font-medium cursor-pointer" : "cursor-pointer hover:text-blue-600"}
          >
            Wishlist
          </li>
          ...
          <li
            ...
            className={activeTab === "details" ? "text-blue-600 font-medium cursor-pointer" : "cursor-pointer hover:text-blue-600"}
          >
            Account Details
          </li>
  ...
  >
    ...
    <div className="flex justify-between items-center bg-gray-50 px-4 py-2 border-b">
      <p className="text-sm text-gray-500">
        Order ID: <span className="font-medium text-gray-700">{o._id.slice(-6)}</span>
      </p>
    ...
    <div className="flex justify-between items-center bg-gray-50 px-4 py-3 border-t">
      <p className="font-semibold text-gray-800">Total: ₹{o.amount}</p>
