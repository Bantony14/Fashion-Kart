...
const router = createBrowserRouter(
  createRoutesFromElements(
    <>
      ...
      <Route path="/" element={<HeaderWithLayout />}>
        <Route path="/profilePage" element={<AccountDashboard />}>
          {" "}
        </Route>
      ...
      <Route path="/" element={<ListPageLayout />}>
        <Route path="category/women" element={<WomenProduct />}>
          {" "}
        </Route>
        <Route path="category/accessories" element={<AccProduct />}>
          {" "}
        </Route>
      </Route>
      ...
      <Route path="/" element={<ListPageLayout />}>
        ...
        <Route path="/category/women/pdp" element={<PDP />}>
          {" "}
        </Route>
        <Route path="/category/accessories/pdp" element={<PDP />}>
          {" "}
        </Route>

        <Route path="/listpage/pdp" element={<PDP />}>
          {" "}
        </Route>
      </Route>
